...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        "fixed inset-0 z-[120] bg-black/55 backdrop-blur-sm",
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          "max-h-[90vh] overflow-y-auto rounded-2xl border border-line bg-bg-elevated p-6",
      ...
      >
        ...
        <DialogPrimitive.Close
          className={cn(
            ...
            "text-muted transition-colors hover:bg-bg-soft hover:text-ink",
          )}
        >
